                  ...
                  Expanded(
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(
                          10.0, 50.0, 10.0, 20.0),
                      child: Text(
                        'Let us know what you think about our service, it is always important for us to know how we can improve for you',
                    ...
                    onPressed: () async {
                      await CommentsRecord.collection
                          ...
                          .set(createCommentsRecordData(
                            comments: _model.commentsTextController.text,
                            starts: _model.ratingBarValue?.round(),
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text('Rating'),
                            content: Text('Ratings and comments are sent'),
                            actions: [
                              TextButton(
                                onPressed: () =>
