                          ...
                          children: [
                            Align(
                              ...
                              child: TabBar(
                                ...
                                unselectedLabelColor: const Color(0xFF1B374C),
                                ...
                                indicatorColor: const Color(0xFF1B374C),
                                indicatorWeight: 4.0,
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 12.0, 16.0, 12.0),
                                tabs: const [
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 12.0, 0.0, 24.0),
                                            child: Text(
                                              'Welcome to the school and tourist transport app',
