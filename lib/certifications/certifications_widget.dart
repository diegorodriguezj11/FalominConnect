...
export 'certifications_model.dart';

class CertificationsWidget extends StatefulWidget {
  const CertificationsWidget({super.key});

  static String routeName = 'Certifications';
  static String routePath = '/certifications';
...
class _CertificationsWidgetState extends State<CertificationsWidget> {
  late CertificationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CertificationsModel());
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await CertificationsRecord.collection
                            .doc()
                            .set(createCertificationsRecordData(
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            backgroundColor: Color(0xFF44D239),
                          ),
                        );
                      },
                      text: 'Register Certification',
