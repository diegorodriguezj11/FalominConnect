...
import 'create_driver_model.dart';
export 'create_driver_model.dart';

class CreateDriverWidget extends StatefulWidget {
  const CreateDriverWidget({super.key});

  static String routeName = 'CreateDriver';
  static String routePath = '/createDriver';

  @override
  State<CreateDriverWidget> createState() => _CreateDriverWidgetState();
}

class _CreateDriverWidgetState extends State<CreateDriverWidget> {
  late CreateDriverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateDriverModel());
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                                                    ...
                                                    valueOrDefault<String>(
                                                      _model.uploadedFileUrl !=
                                                          ...
                                                          ? _model
                                                              .uploadedFileUrl
                                                          : '',
                                                      'https://firebasestorage.googleapis.com/v0/b/tienda-f7723.appspot.com/o/descarga.png?alt=media&token=9cb1b5e9-f801-4392-836f-4e043c5a0013',
                                                    ),
                                                    width: 131.2,
                                                    height: 143.41,
                                                    fit: BoxFit.cover,
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      cursorColor:
                                                          Color(0xFF6F61EF),
                                                      validator: _model
                                                          .txtNameTextController3Validator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                              ...
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  cursorColor:
                                                      Color(0xFF6F61EF),
                                                  validator: _model
                                                      .txtNameTextController5Validator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .txtNameTextController6,
                                                  focusNode:
                                                      _model.txtNameFocusNode6,
                                                  autofocus: true,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelText: 'Email',
                                                  ...
                                                  cursorColor:
                                                      Color(0xFF6F61EF),
                                                  validator: _model
                                                      .txtNameTextController6Validator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .txtNameTextController7,
                                                  focusNode:
                                                      _model.txtNameFocusNode7,
                                                  autofocus: true,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelText:
                                                  ...
                                                  cursorColor:
                                                      Color(0xFF6F61EF),
                                                  validator: _model
                                                      .txtNameTextController7Validator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            StreamBuilder<
                                                List<CertificationsRecord>>(
                                              stream:
                                                  queryCertificationsRecord(),
                                              builder: (context, snapshot) {
                                                // Customize what your widget looks like when it's loading.
                                                if (!snapshot.hasData) {
                                                  return Center(
                                                ...
                                                List<CertificationsRecord>
                                                    dropDownCertificationsRecordList =
                                                    snapshot.data!;
                                              ...
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  cursorColor:
                                                      Color(0xFF6F61EF),
                                                  validator: _model
                                                      .txtNameTextController10Validator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await actions.createDriverAndUser(
                                    ...
                                    _model.txtNameTextController5.text,
                                    ...
                                    valueOrDefault<String>(
                                      _model.uploadedFileUrl != ''
                                          ? _model.uploadedFileUrl
                                          : '',
                                      'https://firebasestorage.googleapis.com/v0/b/tienda-f7723.appspot.com/o/users%2Fdescarga.png?alt=media&token=3366378a-7c9c-438d-967c-7d407cbcf579',
                                    ),
                                  );
                                  context.safePop();
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      ...
                                      backgroundColor: Color(0xFF5DD239),
                                    ),
                                  );
                                },
                                text: 'Save',
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  context
                                      .pushNamed(UserPasswordWidget.routeName);
                                },
                                text: 'Password reset',
                                options: FFButtonOptions(
                                  width: MediaQuery.sizeOf(context).width * 1.0,
