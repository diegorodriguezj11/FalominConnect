...
class UserEditWidget extends StatefulWidget {
  const UserEditWidget({
    ...
    bool? roleSwitchParameter,
    required this.userSelectionParameter,
        ...
        this.emailParameter = emailParameter ?? 'no mail',
        this.userName = userName ?? 'no name',
        this.phoneParameter = phoneParameter ?? 'no phone',
        this.roleParameter = roleParameter ?? 'no role',
        this.roleSwitchParameter = roleSwitchParameter ?? false;

  final String imageParameter;
  final String emailParameter;
  final String userName;
  final String phoneParameter;
  final String roleParameter;
  final bool roleSwitchParameter;
  final DocumentReference? userSelectionParameter;

  static String routeName = 'UserEdit';
  static String routePath = '/userEdit';
...
class _UserEditWidgetState extends State<UserEditWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.emailParameter);
    ...
    _model.textController3 ??=
        TextEditingController(text: widget.phoneParameter);
    _model.textFieldFocusNode3 ??= FocusNode();

    _model.switchValue = widget.roleSwitchParameter;
            ...
            children: [
              ...
              FlutterFlowDropDown<String>(
                controller: _model.dropDownValueController ??=
                  ...
                  _model.dropDownValue ??= widget.roleParameter,
                ),
                options: ['Administrator', 'Driver', 'User'],
                onChanged: (val) =>
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Switch.adaptive(
                      ...
                      activeTrackColor: Color(0xFF1B374C),
                      inactiveTrackColor:
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        await widget.userSelectionParameter!
                            .update(createUsersRecordData(
                          email: widget.emailParameter,
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: Text('User successfully edited'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
