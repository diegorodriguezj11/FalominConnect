...
import 'user_password_model.dart';
export 'user_password_model.dart';

class UserPasswordWidget extends StatefulWidget {
  const UserPasswordWidget({super.key});

  static String routeName = 'UserPassword';
  static String routePath = '/userPassword';
...
class _UserPasswordWidgetState extends State<UserPasswordWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserPasswordModel());
